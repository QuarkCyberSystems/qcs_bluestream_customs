...
def get_chart_data(periodic_data, columns):
	labels = ["Rejected", "Accepted", "Partially Accepted"]

	status_wise_data = {"Accepted": 0, "Rejected": 0, "Partially Accepted": 0}
	...
	datasets.append(
		{
			"name": "Qty Wise Chart",
			"values": [status_wise_data.get("Rejected"), status_wise_data.get("Accepted"), status_wise_data.get("Partially Accepted")],
		}
	)
